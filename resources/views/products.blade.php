...
<body>
    ...
    <div class="product-header">
        <div class="container">
            <h2>{{ $pageTitle ?? 'Koleksi Produk' }}</h2>
            <p class="text-muted">{{ $pageSubtitle ?? 'Tampil maksimal dengan pilihan streetwear terbaik.' }}</p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 text-center py-5">
                    <p class="text-muted">Produk {{ strtolower($pageTitle ?? 'ini') }} belum tersedia.</p>
                </div>
                @endforelse
            </div>
        </div>
